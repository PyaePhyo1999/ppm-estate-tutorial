  ...
  return (
    <motion.div 
        ...
        className='container flex flex-col justify-center items-center 
         mx-auto w-full overflow-hidden p-14 md:px-20' id='About'>
        ...
        <div className='flex flex-col items-center md:flex-row md:items-start md:gap-20'>
            ...
            <div className='flex flex-col items-center mt-10 text-gray-500 md:items-start'>
                <div className='grid grid-cols-2 gap-6 w-full 2xl:pr-28 md:gap-10'>
                    <div>
